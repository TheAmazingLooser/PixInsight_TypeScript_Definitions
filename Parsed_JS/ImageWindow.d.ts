...
declare class ImageWindow {
    ...
    public astrometricSolution(): Array;
    ...
    public celestialToImage(eqDeg: Array): Array;

    public celestialToImage(alphaDeg: Array, deltaDeg: Array): Array;
    ...
    public imageToCelestial(xy: Array): Array;

    public imageToCelestial(x: Array, y: Array): Array;
    ...
    public setAstrometricSolution(keywords: Array, controlPoints: ByteArray): void;
    ...
    //----static Functions-----
    //-------------------------
    public static open(url: string, id?: string /* ''*/, formatHints?: string /* ''*/, asCopy?: boolean /* false*/): Array;
