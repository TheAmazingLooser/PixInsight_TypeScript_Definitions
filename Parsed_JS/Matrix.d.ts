...
declare class Matrix {
    ...
    constructor(a: Array, rows: number, cols: number);
    constructor(a: Array, startIndex: number, rows: number, cols: number);
    ...
    public assign(a: Array): void;

    public assign(a: Array, rows: number, cols: number): void;

    public assign(a: Array, startIndex: number, rows: number, cols: number): void;
    ...
    public binarySearch(value: number): Array | void;
    ...
    public linearSearch(value: number): Array | void;
    ...
    public toArray(startRow?: number /* 0*/, startCol?: number /* 0*/, rows?: number /* rows*/, cols?: number /* cols*/): Array;
