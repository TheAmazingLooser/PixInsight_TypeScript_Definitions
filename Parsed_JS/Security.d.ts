...
declare class Security {
    ...
    //----static Functions-----
    //-------------------------
    public static certifiedDevelopers(): Array;
    ...
    public static generateScriptSignatureFile(outputFilePath: string, scriptFilePath: string, entitlements: Array, developerId: string, publicKey: ByteArray, privateKey: ByteArray): void;

    public static generateScriptSignatureFile(outputFilePath: string, scriptFilePath: string, entitlements: Array, keysFilePath: string, password: string | ByteArray): void;
